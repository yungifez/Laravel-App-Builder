...
{
    /**
     * Queue a verification run for the feature request's change.
     *
     * @throws ValidationException when there is no generated change or a run is already in progress.
     */
    public function handle(FeatureRequest $featureRequest): Verification
    {
        ...
        VerifyFeatureRequest::dispatch($verification);

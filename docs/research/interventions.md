...
| 7   | The agent recorded direction 22 as a new architecture section appended at the end. The owner asked for it to be folded into the existing sections instead, after reviewing them.       | Architecture drift | Owner                        | A note saying the architecture document is edited in place; direction files hold the verbatim input. |
